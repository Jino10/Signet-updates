              ...
              <Form noValidate validated={validated} className="fromWrap" onSubmit={handleSubmit}>
                ...
                <div style={{ marginBottom: '15px' }}>
                  <Row>
                    <Col>
                      <Form.Group>
                        <Form.Control as='select' onChange={(e) => handleCountry(e.target.value)}>
                          <option>--Country--</option>
                          {
                            countries.map((listCountry) =>
                              <option value={listCountry.isoCode}>{listCountry.name}</option>
                            )
                          }
                        </Form.Control>
                        <Form.Control.Feedback type="invalid">Country field is required</Form.Control.Feedback>
                      </Form.Group>
                    </Col>
                    <Col>
                      <Form.Group>
                        <Form.Control as='select' onChange={(e) => handleState(e.target.value)}>
                          <option>--State--</option>
                          {
                            states.map((listState) =>
                              <option value={listState.isoCode}>{listState.name}</option>
                            )
                          }
                        </Form.Control>
                        <Form.Control.Feedback type="invalid">State field is required</Form.Control.Feedback>
                      </Form.Group>
                    </Col>
                    <Col>
                      <Form.Group>
                        <Form.Control as='select'>
                          ...
                          {
                            cities.map((listCity) =>
                              <option value={listCity.stateCode}>{listCity.name}</option>
                            )
                          }
                        </Form.Control>
